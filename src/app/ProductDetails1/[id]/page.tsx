  ...
  <div className="container mx-auto px-4 py-8">
    <div className="flex flex-wrap -mx-4">
      ...
      <div className="w-full md:w-1/2 px-4">
        ...
        <div className="mb-4">
          <span className="text-2xl font-bold mr-2">${response?.price}</span>
        ...
        <div className="flex items-center mb-4">
          ...
          <span className="ml-2 text-gray-600">{response?.ratingsAverage} ({response?.reviews.length} reviews)</span>
        </div>
     ...
     <Addbtn  prodId={response._id} cls={"bg-green-600 flex gap-2 items-center text-white px-6 py-2 rounded-md hover:bg-[rgb(49,243,49)] curser focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"} child={<>    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
